...
const Fabric_Stores = () => {
  ...
  <div className='flex lg:flex-row flex-col w-full justify-between'>
    ...
    <div
      ...
      className="lg:w-auto w-full lg:order-2 sm:order-1 md:order-1"
    >
      <div className='mt-2'>
...
<div className='mt-10 relative'>
  <div className='container'>
    {loadingbelow && (
      <p className="text-center py-4 bottom-0">
